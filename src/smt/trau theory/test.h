...
namespace smt {
    ...
    theory_str2::theory_str2(ast_manager &m, const theory_str_params &params)
            : theory{m.mk_family_id("seq")}, m_params{params}, m_rewrite{m}, m_util_a{m},
              m_util_s{m}, m{m}, m_length(m),m_fresh_id(0) {}
...
//            print_ast(e);
    ...
    void theory_str2::handle_word_eq(expr_ref lhs, expr_ref rhs){
     ...
     void theory_str2::word_eq_under_approx(expr* lhs, expr* rhs, expr_ref_vector & items){
    ...
    expr_ref theory_str2::construct_basic_str_ctr(
        ast_manager& m,
    ...
    std::vector<std::pair<expr_ref,expr_ref>>  theory_str2::init_int_vars(unsigned p,unsigned q, std::string s){
    ...
    ptr_vector<expr> theory_str2::get_int_vars_from_aut(pautomaton* aut, unsigned s){
     ...
     expr * theory_str2::get_eqc_value(expr * n, bool & hasEqcValue) {
        return nullptr;
    }
    void theory_str2::get_nodes_in_concat(expr * node, ptr_vector<expr> & nodeList) {
    ...
    void theory_str2::handle_word_diseq(expr_ref lhs, expr_ref rhs){
    ...
    */
    ...
    zstring theory_str2::print_word_term(expr * e) const{
        ...
        std::vector<expr*> theory_str2::get_vars(expr * e) const{
        ...
        zstring theory_str2::print_vars(expr * e) const{
    ...
    expr* theory_str2::get_vars(expr * e, ptr_vector<expr> lst) const{
               // ptr_vector<expr> ex;
               zstring s;
                if (m_util_s.str.is_string(e, s)) {
                    return nullptr;               
    ...
    bool theory_str2::contains_elt(app* elt, scoped_vector<app*> vec) {
        ast_manager& m = get_manager();
